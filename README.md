...
To authenticate, you need to provide the API key in the header. The key is generated by Areal.ai and is unique to each user.
...
Customer Account ID is the username procvided and the Customer Key is the API Key provided. Both parts are separated by a colon. 

If you do not have a key yet, please contact team@areal.ai.
